...
describe("over raise - full lever", function() {
    before(async function() {
    loger("===================================================================================");
    loger("test time: " + new Date().toString());
    loger("-------------- Task Description -------------");
    loger("test name: over raise full lever");
    ...
    this.gp1DepositTokenAmount = getBigNumber(100000);
    this.gp2DepositTokenAmount = getBigNumber(200000);
    this.lp1DepositTokenAmount = getBigNumber(200000);
    this.lp2DepositTokenAmount = getBigNumber(300000);
    this.dgtTokenAmount = 0;
    this.impawnRatio = 500000;
    this.closeLine = 1000000;
    this.chargeRatio = 100000;
    this.duration = 360; //NudgePool duration
