...
describe("over raise - short level", function() {
    before(async function() {
    loger("===================================================================================");
    loger("test time: " + new Date().toString());
    loger("-------------- Task Description -------------");
    loger("test name: over raise short lever");
    ...
    this.gp1DepositTokenAmount = getBigNumber(200000);
    this.gp2DepositTokenAmount = getBigNumber(50000);
    this.lp1DepositTokenAmount = getBigNumber(5000);
    this.lp2DepositTokenAmount = getBigNumber(500);
  ...
  it("GP deposit raising", async function() {
    ...
    expect(GP1BaseTokenAmount).to.be.equal(this.gp1DepositTokenAmount);
  })
