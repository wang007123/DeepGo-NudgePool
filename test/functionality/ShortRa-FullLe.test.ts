...
describe("short raise - full level", function() {
    before(async function() {
    loger("===================================================================================");
    loger("test time: " + new Date().toString());
    loger("-------------- Task Description -------------");
    loger("test name: short raise full lever");
    ...
    this.gp2DepositTokenAmount = getBigNumber(600);
    this.lp1DepositTokenAmount = getBigNumber(1000);
